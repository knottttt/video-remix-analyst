...
- Include a `SOUND:` directive per segment: music mood, SFX, and especially transition moments (e.g., "music explodes into full chaos horns", "cuts dead the instant Barry hits the sand")
